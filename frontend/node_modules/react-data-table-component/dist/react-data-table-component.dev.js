...
function sort(rows, field, direction, sortFn) {
    ...
    return orderBy__default['default'](rows, field, direction);
}
...
function tableReducer(state, action) {
    switch (action.type) {
        ...
        case 'SELECT_ALL_ROWS': {
            ...
            if (mergeSelections) {
                var selections = allChecked
                    ? __spreadArrays(state.selectedRows, rows_1.filter(function (row) { return !isRowSelected(row, state.selectedRows, keyField_1); })) : state.selectedRows.filter(function (row) { return !isRowSelected(row, rows_1, keyField_1); });
                return __assign(__assign({}, state), { allSelected: allChecked, selectedCount: selections.length, selectedRows: selections });
            }
            return __assign(__assign({}, state), { allSelected: allChecked, selectedCount: allChecked ? rowCount : 0, selectedRows: allChecked ? rows_1 : [] });
        }
        case 'SELECT_SINGLE_ROW': {
            var keyField = action.keyField, row = action.row, isSelected = action.isSelected, rowCount = action.rowCount;
            if (isSelected) {
                return __assign(__assign({}, state), { selectedCount: state.selectedRows.length > 0 ? state.selectedRows.length - 1 : 0, allSelected: false, selectedRows: removeItem(state.selectedRows, row, keyField) });
            }
            return __assign(__assign({}, state), { selectedCount: state.selectedRows.length + 1, allSelected: state.selectedRows.length + 1 === rowCount, selectedRows: insertItem(state.selectedRows, row) });
        }
        case 'SELECT_MULTIPLE_ROWS': {
            ...
            if (mergeSelections) {
                var selections = __spreadArrays(state.selectedRows, selectedRows.filter(function (row) { return !isRowSelected(row, state.selectedRows, keyField_2); }));
                return __assign(__assign({}, state), { selectedCount: selections.length, allSelected: false, selectedRows: selections });
            }
        ...
        case 'SORT_CHANGE': {
            var rows = action.rows, sortDirection = action.sortDirection, sortServer = action.sortServer, selectedColumn = action.selectedColumn, pagination = action.pagination, paginationServer = action.paginationServer, visibleOnly = action.visibleOnly, persistSelectedOnSort = action.persistSelectedOnSort;
...
var disabledCSS = styled.css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n\tpointer-events: none;\n\topacity: 0.4;\n"], ["\n\tpointer-events: none;\n\topacity: 0.4;\n"])));
var TableStyle = styled__default['default'].div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n\tposition: relative;\n\tbox-sizing: border-box;\n\tdisplay: flex;\n\tflex-direction: column;\n\twidth: 100%;\n\theight: 100%;\n\tmax-width: 100%;\n\t", ";\n\t", ";\n"], ["\n\tposition: relative;\n\tbox-sizing: border-box;\n\tdisplay: flex;\n\tflex-direction: column;\n\twidth: 100%;\n\theight: 100%;\n\tmax-width: 100%;\n\t", ";\n\t", ";\n"])), function (_a) {
...
var TableHead = styled__default['default'].div(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n\tdisplay: flex;\n\ttext-align: left;\n\t", ";\n"], ["\n\tdisplay: flex;\n\ttext-align: left;\n\t", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.head.style;
});
var templateObject_1$1;

var disabledCSS$1 = styled.css(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n\tpointer-events: none;\n"], ["\n\tpointer-events: none;\n"])));
var TableHeadRow = styled__default['default'].div(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n\tdisplay: flex;\n\talign-items: stretch;\n\twidth: 100%;\n\t", ";\n\t", ";\n\t", ";\n"], ["\n\tdisplay: flex;\n\talign-items: stretch;\n\twidth: 100%;\n\t", ";\n\t", ";\n\t", ";\n"])), function (_a) {
    var theme = _a.theme;
...
var media = {
    ...
    lg: function (literals) {
        ...
        return styled.css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n\t\t@media screen and (max-width: ", "px) {\n\t\t\t", "\n\t\t}\n\t"], ["\n\t\t@media screen and (max-width: ", "px) {\n\t\t\t", "\n\t\t}\n\t"])), LARGE, styled.css.apply(void 0, __spreadArrays([literals], args)));
    },
    custom: function (value) { return function (literals) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
        return styled.css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n\t\t@media screen and (max-width: ", "px) {\n\t\t\t", "\n\t\t}\n\t"], ["\n\t\t@media screen and (max-width: ", "px) {\n\t\t\t", "\n\t\t}\n\t"])), value, styled.css.apply(void 0, __spreadArrays([literals], args)));
    }; },
};
var templateObject_1$3, templateObject_2$2, templateObject_3, templateObject_4;

var CellBase = styled__default['default'].div(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n\tposition: relative;\n\tdisplay: flex;\n\talign-items: center;\n\tbox-sizing: border-box;\n\tline-height: normal;\n\t", ";\n\t", ";\n"], ["\n\tposition: relative;\n\tdisplay: flex;\n\talign-items: center;\n\tbox-sizing: border-box;\n\tline-height: normal;\n\t", ";\n\t", ";\n"])), function (_a) {
...
var Cell = styled__default['default'](CellBase)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n\tflex-grow: ", ";\n\tflex-shrink: 0;\n\tflex-basis: 0;\n\tmax-width: ", ";\n\tmin-width: ", ";\n\t", ";\n\t", ";\n\t", ";\n\t", ";\n\n\t/* handle hiding cells */\n\t", ";\n\t", ";\n\t", ";\n\t", ";\n"], ["\n\tflex-grow: ", ";\n\tflex-shrink: 0;\n\tflex-basis: 0;\n\tmax-width: ", ";\n\tmin-width: ", ";\n\t",
    ";\n\t", ";\n\t", ";\n\t", ";\n\n\t/* handle hiding cells */\n\t",
    ";\n\t",
    ";\n\t",
    ";\n\t",
    ...
    var width = _a.width;
    return width && styled.css(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["\n\t\t\tmin-width: ", ";\n\t\t\tmax-width: ", ";\n\t\t"], ["\n\t\t\tmin-width: ", ";\n\t\t\tmax-width: ", ";\n\t\t"])), width, width);
}, function (_a) {
    var right = _a.right;
    ...
    var hide = _a.hide;
    return hide &&
        hide === 'sm' && media.sm(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n    display: none;\n  "], ["\n    display: none;\n  "])));
}, function (_a) {
    var hide = _a.hide;
    return hide &&
        hide === 'md' && media.md(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n    display: none;\n  "], ["\n    display: none;\n  "])));
}, function (_a) {
    var hide = _a.hide;
    return hide &&
        hide === 'lg' && media.lg(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n    display: none;\n  "], ["\n    display: none;\n  "])));
}, function (_a) {
    var hide = _a.hide;
    return hide &&
        Number.isInteger(hide) && media.custom(hide)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n    display: none;\n  "], ["\n    display: none;\n  "])));
});
...
var overflowCSS = styled.css(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["\n\tdiv:first-child {\n\t\twhite-space: ", ";\n\t\toverflow: ", ";\n\t\ttext-overflow: ellipsis;\n\t}\n"], ["\n\tdiv:first-child {\n\t\twhite-space: ", ";\n\t\toverflow: ", ";\n\t\ttext-overflow: ellipsis;\n\t}\n"])), function (_a) {
...
var TableCellStyle = styled__default['default'](Cell)(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n\tfont-size: ", ";\n\tfont-weight: 400;\n\t", ";\n\t", ";\n\t", ";\n"], ["\n\tfont-size: ", ";\n\tfont-weight: 400;\n\t", ";\n\t", ";\n\t", ";\n"])), function (_a) {
    var theme = _a.theme;
    ...
    var extendedCellStyle = _a.extendedCellStyle;
    return extendedCellStyle;
});
function TableCell(_a) {
    ...
    return (React.createElement(TableCellStyle, { id: id, role: "gridcell", className: "rdt_TableCell", "data-tag": dataTag, cellStyle: column.style, extendedCellStyle: extendedCellStyle, renderAsCell: renderAsCell, allowOverflow: column.allowOverflow, button: column.button, center: column.center, compact: column.compact, grow: column.grow, hide: column.hide, maxWidth: column.maxWidth, minWidth: column.minWidth, right: column.right, width: column.width, wrapCell: column.wrap }, children));
}
var TableCell$1 = React.memo(TableCell);
...
function Checkbox(_a) {
    ...
    var resolvedComponentOptions = React.useMemo(function () { return handleFunctionProps(componentOptions, indeterminate); }, [
        componentOptions,
        indeterminate,
    ]);
    return (React.createElement(TagName, __assign({ type: "checkbox", ref: setCheckboxRef, style: baseStyle, onClick: disabled ? noop : onClick, name: name, "aria-label": name, checked: checked, disabled: disabled }, resolvedComponentOptions, { onChange: noop })));
}
var Checkbox$1 = React.memo(Checkbox);

var TableCellCheckboxStyle = styled__default['default'](CellBase)(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["\n\tflex: 0 0 48px;\n\tjustify-content: center;\n\talign-items: center;\n\tuser-select: none;\n\twhite-space: nowrap;\n"], ["\n\tflex: 0 0 48px;\n\tjustify-content: center;\n\talign-items: center;\n\tuser-select: none;\n\twhite-space: nowrap;\n"])));
function TableCellCheckbox(_a) {
    var keyField = _a.keyField, row = _a.row, rowCount = _a.rowCount, selected = _a.selected, selectableRowsComponent = _a.selectableRowsComponent, selectableRowsComponentProps = _a.selectableRowsComponentProps, selectableRowDisabled = _a.selectableRowDisabled, onSelectedRow = _a.onSelectedRow;
    ...
    return (React.createElement(TableCellCheckboxStyle, { onClick: function (e) { return e.stopPropagation(); }, className: "rdt_TableCell", noPadding: true },
        React.createElement(Checkbox$1, { name: "select-row-" + row[keyField], component: selectableRowsComponent, componentOptions: selectableRowsComponentProps, checked: selected, "aria-checked": selected, onClick: handleOnRowSelected, disabled: disabled })));
}
var templateObject_1$6;

var ButtonStyle = styled__default['default'].button(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n\tdisplay: inline-flex;\n\talign-items: center;\n\tuser-select: none;\n\twhite-space: nowrap;\n\tborder: none;\n\tbackground-color: transparent;\n\t", ";\n"], ["\n\tdisplay: inline-flex;\n\talign-items: center;\n\tuser-select: none;\n\twhite-space: nowrap;\n\tborder: none;\n\tbackground-color: transparent;\n\t", ";\n"])), function (_a) {
    var theme = _a.theme;
...
var TableCellExpanderStyle = styled__default['default'](CellBase)(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["\n\twhite-space: nowrap;\n\tfont-weight: 400;\n\t", ";\n"], ["\n\twhite-space: nowrap;\n\tfont-weight: 400;\n\t", ";\n"])), function (_a) {
    var theme = _a.theme;
...
function TableCellExpander(_a) {
    ...
    return (React.createElement(TableCellExpanderStyle, { onClick: function (e) { return e.stopPropagation(); }, noPadding: true },
...
function renderChildren(children, data) {
    return React.Children.map(children, function (child) { return React.cloneElement(child, { data: data }); });
}
var ExpanderRowStyle = styled__default['default'].div(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n\twidth: 100%;\n\tbox-sizing: border-box;\n\t", ";\n\t", ";\n"], ["\n\twidth: 100%;\n\tbox-sizing: border-box;\n\t", ";\n\t", ";\n"])), function (_a) {
    var theme = _a.theme;
...
function ExpanderRow(_a) {
    var data = _a.data, children = _a.children, extendedRowStyle = _a.extendedRowStyle;
    return (React.createElement(ExpanderRowStyle, { className: "rdt_ExpanderRow", extendedRowStyle: extendedRowStyle }, renderChildren(children, data)));
}
...
var defaultProps = {
    ...
    expandableRowsComponent: (React__default['default'].createElement("div", { style: { padding: '24px' } }, "Add a custom expander component. Use props.data for row data")),
    expandableIcon: {
...
var highlightCSS = styled.css(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["\n\t&:hover {\n\t\t", ";\n\t}\n"], ["\n\t&:hover {\n\t\t", ";\n\t}\n"])), function (_a) {
    var highlightOnHover = _a.highlightOnHover, theme = _a.theme;
    return highlightOnHover && theme.rows.highlightOnHoverStyle;
});
var pointerCSS = styled.css(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n\t&:hover {\n\t\tcursor: pointer;\n\t}\n"], ["\n\t&:hover {\n\t\tcursor: pointer;\n\t}\n"])));
var TableRowStyle = styled__default['default'].div(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n\tdisplay: flex;\n\talign-items: stretch;\n\talign-content: stretch;\n\twidth: 100%;\n\tbox-sizing: border-box;\n\t", ";\n\t", ";\n\t", ";\n\t", ";\n\t", ";\n\t", ";\n\t", ";\n"], ["\n\tdisplay: flex;\n\talign-items: stretch;\n\talign-content: stretch;\n\twidth: 100%;\n\tbox-sizing: border-box;\n\t", ";\n\t", ";\n\t", ";\n\t", ";\n\t", ";\n\t", ";\n\t", ";\n"])), function (_a) {
    var theme = _a.theme;
...
function TableRow(_a) {
    var _b = _a.columns, columns = _b === void 0 ? [] : _b, _c = _a.conditionalRowStyles, conditionalRowStyles = _c === void 0 ? [] : _c, _d = _a.defaultExpanded, defaultExpanded = _d === void 0 ? false : _d, _e = _a.defaultExpanderDisabled, defaultExpanderDisabled = _e === void 0 ? false : _e, _f = _a.dense, dense = _f === void 0 ? false : _f, _g = _a.expandableIcon, expandableIcon = _g === void 0 ? defaultProps.expandableIcon : _g, _h = _a.expandableRows, expandableRows = _h === void 0 ? false : _h, _j = _a.expandableRowsComponent, expandableRowsComponent = _j === void 0 ? defaultProps.expandableRowsComponent : _j, expandableRowsHideExpander = _a.expandableRowsHideExpander, _k = _a.expandOnRowClicked, expandOnRowClicked = _k === void 0 ? false : _k, _l = _a.expandOnRowDoubleClicked, expandOnRowDoubleClicked = _l === void 0 ? false : _l, _m = _a.highlightOnHover, highlightOnHover = _m === void 0 ? false : _m, id = _a.id, expandableInheritConditionalStyles = _a.expandableInheritConditionalStyles, _o = _a.keyField, keyField = _o === void 0 ? defaultProps.keyField : _o, _p = _a.onRowClicked, onRowClicked = _p === void 0 ? noop : _p, _q = _a.onRowDoubleClicked, onRowDoubleClicked = _q === void 0 ? noop : _q, _r = _a.onRowExpandToggled, onRowExpandToggled = _r === void 0 ? noop : _r, _s = _a.onSelectedRow, onSelectedRow = _s === void 0 ? noop : _s, _t = _a.pointerOnHover, pointerOnHover = _t === void 0 ? false : _t, row = _a.row, rowCount = _a.rowCount, rowIndex = _a.rowIndex, _u = _a.selectableRowDisabled, selectableRowDisabled = _u === void 0 ? null : _u, _v = _a.selectableRows, selectableRows = _v === void 0 ? false : _v, _w = _a.selectableRowsComponent, selectableRowsComponent = _w === void 0 ? defaultProps.selectableRowsComponent : _w, _x = _a.selectableRowsComponentProps, selectableRowsComponentProps = _x === void 0 ? defaultProps.selectableRowsComponentProps : _x, _y = _a.selectableRowsHighlight, selectableRowsHighlight = _y === void 0 ? false : _y, selected = _a.selected, _z = _a.striped, striped = _z === void 0 ? false : _z;
    var _0 = React.useState(defaultExpanded), expanded = _0[0], setExpanded = _0[1];
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(TableRowStyle, { id: "row-" + id, role: "row", striped: isStriped, highlightOnHover: highlightOnHover, pointerOnHover: !defaultExpanderDisabled && showPointer, dense: dense, onClick: handleRowClick, onDoubleClick: handleRowDoubleClick, className: "rdt_TableRow", extendedRowStyle: extendedRowStyle, selected: hightlightSelected },
            selectableRows && (React.createElement(TableCellCheckbox, { keyField: keyField, row: row, rowCount: rowCount, selected: selected, selectableRowsComponent: selectableRowsComponent, selectableRowsComponentProps: selectableRowsComponentProps, selectableRowDisabled: selectableRowDisabled, onSelectedRow: onSelectedRow })),
            expandableRows && !expandableRowsHideExpander && (React.createElement(TableCellExpander, { id: row[keyField], expandableIcon: expandableIcon, expanded: expanded, row: row, onToggled: handleExpanded, disabled: defaultExpanderDisabled })),
            columns.map(function (column) {
                ...
                return (React.createElement(TableCell$1, { id: "cell-" + column.id + "-" + row[keyField], key: "cell-" + column.id + "-" + row[keyField], extendedCellStyle: extendedCellStyle, dataTag: dataTag, renderAsCell: !!column.cell, column: column },
                    !column.cell && (React.createElement("div", { "data-tag": dataTag }, getProperty(row, column.selector, column.format, rowIndex))),
                    column.cell && column.cell(row, rowIndex, column, id)));
            })),
        expandableRows && expanded && (React.createElement(ExpanderRow, { key: "expander--" + row[keyField], data: row, extendedRowStyle: inheritStyles }, expandableRowsComponent))));
}
var templateObject_1$a, templateObject_2$5, templateObject_3$2;

var Icon = styled__default['default'].span(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["\n\tpadding: 2px;\n\tcolor: inherit;\n\tflex-grow: 0;\n\tflex-shrink: 0;\n\t", ";\n\t", ";\n"], ["\n\tpadding: 2px;\n\tcolor: inherit;\n\tflex-grow: 0;\n\tflex-shrink: 0;\n\t", ";\n\t", ";\n"])), function (_a) {
...
var TableColStyle = styled__default['default'](Cell)(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["\n\t", ";\n"], ["\n\t", ";\n"])), function (_a) {
    var button = _a.button;
    return button && 'text-align: center';
});
var ColumnSortable = styled__default['default'].div(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["\n\tdisplay: inline-flex;\n\talign-items: center;\n\theight: 100%;\n\tline-height: 1;\n\tuser-select: none;\n\t", ";\n\n\tspan.__rdt_custom_sort_icon__ {\n\t\ti,\n\t\tsvg {\n\t\t\t", ";\n\t\t\tcolor: inherit;\n\t\t\tfont-size: 18px !important;\n\t\t\theight: 18px !important;\n\t\t\twidth: 18px !important;\n\t\t\tbackface-visibility: hidden;\n\t\t\ttransform-style: preserve-3d;\n\t\t\ttransition-duration: 125ms;\n\t\t\ttransition-property: transform;\n\t\t}\n\n\t\t&.asc i,\n\t\t&.asc svg {\n\t\t\ttransform: rotate(180deg);\n\t\t}\n\t}\n\n\t&:hover {\n\t\t", ";\n\t\t", ";\n\n\t\tspan,\n\t\tspan.__rdt_custom_sort_icon__ * {\n\t\t\t", ";\n\t\t}\n\t}\n"], ["\n\tdisplay: inline-flex;\n\talign-items: center;\n\theight: 100%;\n\tline-height: 1;\n\tuser-select: none;\n\t", ";\n\n\tspan.__rdt_custom_sort_icon__ {\n\t\ti,\n\t\tsvg {\n\t\t\t", ";\n\t\t\tcolor: inherit;\n\t\t\tfont-size: 18px !important;\n\t\t\theight: 18px !important;\n\t\t\twidth: 18px !important;\n\t\t\tbackface-visibility: hidden;\n\t\t\ttransform-style: preserve-3d;\n\t\t\ttransition-duration: 125ms;\n\t\t\ttransition-property: transform;\n\t\t}\n\n\t\t&.asc i,\n\t\t&.asc svg {\n\t\t\ttransform: rotate(180deg);\n\t\t}\n\t}\n\n\t&:hover {\n\t\t", ";\n\t\t", ";\n\n\t\tspan,\n\t\tspan.__rdt_custom_sort_icon__ * {\n\t\t\t", ";\n\t\t}\n\t}\n"])), function (_a) {
    ...
    var sortable = _a.sortable, theme = _a.theme;
    return sortable && theme.headCells.activeStyle;
}, function (_a) {
    var sortActive = _a.sortActive, sortable = _a.sortable;
    return !sortActive && sortable && 'opacity: 1';
});
function TableCol(_a) {
    var rows = _a.rows, column = _a.column, selectedColumn = _a.selectedColumn, sortDirection = _a.sortDirection, sortFunction = _a.sortFunction, sortIcon = _a.sortIcon, sortServer = _a.sortServer, pagination = _a.pagination, paginationServer = _a.paginationServer, persistSelectedOnSort = _a.persistSelectedOnSort, selectableRowsVisibleOnly = _a.selectableRowsVisibleOnly, onSort = _a.onSort;
    if (column.omit) {
        return null;
    }
    var handleSortChange = function () {
        if (column.sortable && column.selector) {
            ...
            var sortedRows = sort(rows, column.selector, direction, sortFunction);
            var sortFn_1 = column.sortFunction;
            if (sortFn_1) {
                var customSortFunction = direction === 'asc' ? sortFn_1 : function (a, b) { return sortFn_1(a, b) * -1; };
                sortedRows = __spreadArrays(rows).sort(customSortFunction);
            }
            onSort({
                type: 'SORT_CHANGE',
                rows: sortedRows,
    ...
    var renderNativeSortIcon = function (sortActive) { return (React.createElement(NativeSortIcon, { sortActive: sortActive, sortDirection: sortDirection })); };
    ...
    return (React.createElement(TableColStyle, { className: "rdt_TableCol", head: true, allowOverflow: column.allowOverflow, button: column.button, compact: column.compact, grow: column.grow, hide: column.hide, maxWidth: column.maxWidth, minWidth: column.minWidth, right: column.right, width: column.width }, column.name && (React.createElement(ColumnSortable, { id: "column-" + column.id, role: "columnheader", tabIndex: 0, className: "rdt_TableCol_Sortable", onClick: handleSortChange, onKeyPress: handleKeyPress, sortable: column.sortable, sortActive: sortActive },
        customSortIconRight && renderCustomSortIcon(),
        nativeSortIconRight && renderNativeSortIcon(sortActive),
        React.createElement("div", null, column.name),
        customSortIconLeft && renderCustomSortIcon(),
        nativeSortIconLeft && renderNativeSortIcon(sortActive)))));
}
var TableCol$1 = React.memo(TableCol);
var templateObject_1$c, templateObject_2$6;

var TableColStyle$1 = styled__default['default'](CellBase)(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["\n\tflex: 0 0 48px;\n\tjustify-content: center;\n\talign-items: center;\n\tuser-select: none;\n\twhite-space: nowrap;\n"], ["\n\tflex: 0 0 48px;\n\tjustify-content: center;\n\talign-items: center;\n\tuser-select: none;\n\twhite-space: nowrap;\n"])));
function TableColCheckbox(_a) {
    ...
    return (React.createElement(TableColStyle$1, { className: "rdt_TableCol", head: head, noPadding: true },
...
var Title = styled__default['default'].div(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["\n\tdisplay: flex;\n\talign-items: center;\n\tflex: 1 0 auto;\n\theight: 100%;\n\tcolor: ", ";\n\tfont-size: ", ";\n\tfont-weight: 400;\n"], ["\n\tdisplay: flex;\n\talign-items: center;\n\tflex: 1 0 auto;\n\theight: 100%;\n\tcolor: ", ";\n\tfont-size: ", ";\n\tfont-weight: 400;\n"])), function (_a) {
    var theme = _a.theme;
...
var ContextActions = styled__default['default'].div(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: flex-end;\n\tflex-wrap: wrap;\n"], ["\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: flex-end;\n\tflex-wrap: wrap;\n"])));
...
function ContextMenu(_a) {
    ...
    return (React.createElement(ContextMenuStyle, { visible: visible },
        React.createElement(Title, null, generateDefaultContextTitle(contextMessage, selectedCount, direction)),
        React.createElement(ContextActions, null, contextActions)));
}
var templateObject_1$e, templateObject_2$7, templateObject_3$3;

var TableHeaderStyle = styled__default['default'].div(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["\n\tposition: relative;\n\tbox-sizing: border-box;\n\toverflow: hidden;\n\tdisplay: flex;\n\tflex: 1 1 auto;\n\talign-items: center;\n\tjustify-content: space-between;\n\twidth: 100%;\n\tflex-wrap: wrap;\n\t", "\n"], ["\n\tposition: relative;\n\tbox-sizing: border-box;\n\toverflow: hidden;\n\tdisplay: flex;\n\tflex: 1 1 auto;\n\talign-items: center;\n\tjustify-content: space-between;\n\twidth: 100%;\n\tflex-wrap: wrap;\n\t", "\n"])), function (_a) {
    var theme = _a.theme;
    return theme.header.style;
});
var Title$1 = styled__default['default'].div(templateObject_2$8 || (templateObject_2$8 = __makeTemplateObject(["\n\tflex: 1 0 auto;\n\tcolor: ", ";\n\tfont-size: ", ";\n\tfont-weight: 400;\n"], ["\n\tflex: 1 0 auto;\n\tcolor: ", ";\n\tfont-size: ", ";\n\tfont-weight: 400;\n"])), function (_a) {
    var theme = _a.theme;
...
var Actions = styled__default['default'].div(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n\tflex: 1 0 auto;\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: flex-end;\n\n\t> * {\n\t\tmargin-left: 5px;\n\t}\n"], ["\n\tflex: 1 0 auto;\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: flex-end;\n\n\t> * {\n\t\tmargin-left: 5px;\n\t}\n"])));
var TableHeader = function (_a) {
    var title = _a.title, _b = _a.actions, actions = _b === void 0 ? [] : _b, contextMessage = _a.contextMessage, contextActions = _a.contextActions, contextComponent = _a.contextComponent, selectedCount = _a.selectedCount, direction = _a.direction, _c = _a.showMenu, showMenu = _c === void 0 ? true : _c;
    return (React.createElement(TableHeaderStyle, { className: "rdt_TableHeader", role: "heading", "aria-level": 1 },
...
var SubheaderWrapper = styled__default['default'].header(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["\n\tposition: relative;\n\tdisplay: flex;\n\tflex: 1 1 auto;\n\tbox-sizing: border-box;\n\talign-items: center;\n\tpadding: 4px 16px 4px 24px;\n\twidth: 100%;\n\tjustify-content: ", ";\n\tflex-wrap: ", ";\n\t", "\n"], ["\n\tposition: relative;\n\tdisplay: flex;\n\tflex: 1 1 auto;\n\tbox-sizing: border-box;\n\talign-items: center;\n\tpadding: 4px 16px 4px 24px;\n\twidth: 100%;\n\tjustify-content: ", ";\n\tflex-wrap: ", ";\n\t", "\n"])), function (_a) {
    var align = _a.align;
...
var TableBody = styled__default['default'].div(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n\tdisplay: flex;\n\tflex-direction: column;\n\t", ";\n"], ["\n\tdisplay: flex;\n\tflex-direction: column;\n\t",
    ";\n"])), function (_a) {
    ...
    return fixedHeader && styled.css(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["\n\t\t\tmax-height: ", ";\n\t\t\toverflow-y: scroll;\n\t\t\t-webkit-overflow-scrolling: touch;\n\t\t"], ["\n\t\t\tmax-height: ", ";\n\t\t\toverflow-y: scroll;\n\t\t\t-webkit-overflow-scrolling: touch;\n\t\t"])), hasOffset ? "calc(" + fixedHeaderScrollHeight + " - " + offset + ")" : fixedHeaderScrollHeight);
});
var templateObject_1$h, templateObject_2$9;

var ResponsiveWrapper = styled__default['default'].div(templateObject_3$5 || (templateObject_3$5 = __makeTemplateObject(["\n\tposition: relative;\n\twidth: 100%;\n\tborder-radius: inherit;\n\t", ";\n\t", ";\n"], ["\n\tposition: relative;\n\twidth: 100%;\n\tborder-radius: inherit;\n\t",
    ";\n\t",
    ";\n"])), function (_a) {
    var responsive = _a.responsive;
    return responsive && styled.css(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["\n\t\t\toverflow-x: auto;\n\n\t\t\t// prevents vertical scrolling in firefox\n\t\t\toverflow-y: hidden;\n\t\t\tmin-height: 0;\n\t\t"], ["\n\t\t\toverflow-x: auto;\n\n\t\t\t// prevents vertical scrolling in firefox\n\t\t\toverflow-y: hidden;\n\t\t\tmin-height: 0;\n\t\t"])));
}, function (_a) {
    var overflowY = _a.overflowY, overflowYOffset = _a.overflowYOffset, responsive = _a.responsive;
    return overflowY &&
        responsive &&
        overflowYOffset && styled.css(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n\t\t\tpadding-bottom: ", ";\n\t\t\tmargin-bottom: -", ";\n\t\t"], ["\n\t\t\tpadding-bottom: ", ";\n\t\t\tmargin-bottom: -", ";\n\t\t"])), overflowYOffset, overflowYOffset);
});
var templateObject_1$i, templateObject_2$a, templateObject_3$5;

var ProgressWrapper = styled__default['default'].div(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["\n\tposition: relative;\n\tbox-sizing: border-box;\n\twidth: 100%;\n\theight: 100%;\n\t", ";\n"], ["\n\tposition: relative;\n\tbox-sizing: border-box;\n\twidth: 100%;\n\theight: 100%;\n\t", ";\n"])), function (props) { return props.theme.progress.style; });
var templateObject_1$j;

var TableWrapper = styled__default['default'].div(templateObject_1$k || (templateObject_1$k = __makeTemplateObject(["\n\tposition: relative;\n\twidth: 100%;\n\t", ";\n"], ["\n\tposition: relative;\n\twidth: 100%;\n\t", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.tableWrapper.style;
});
var templateObject_1$k;

var TableColExpander = styled__default['default'](CellBase)(templateObject_1$l || (templateObject_1$l = __makeTemplateObject(["\n\twhite-space: nowrap;\n\t", ";\n"], ["\n\twhite-space: nowrap;\n\t", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.expanderCell.style;
});
var templateObject_1$l;

var NoDataWrapper = styled__default['default'].div(templateObject_1$m || (templateObject_1$m = __makeTemplateObject(["\n\tbox-sizing: border-box;\n\twidth: 100%;\n\theight: 100%;\n\t", ";\n"], ["\n\tbox-sizing: border-box;\n\twidth: 100%;\n\theight: 100%;\n\t", ";\n"])), function (_a) {
    var theme = _a.theme;
...
var SelectControl = styled__default['default'].select(templateObject_1$n || (templateObject_1$n = __makeTemplateObject(["\n\tcursor: pointer;\n\theight: 24px;\n\tmin-width: 24px;\n\tuser-select: none;\n\tpadding-left: 8px;\n\tpadding-right: 12px;\n\tbox-sizing: content-box;\n\tfont-size: inherit;\n\tcolor: inherit;\n\tborder: none;\n\tbackground-color: transparent;\n\tappearance: none;\n\tdirection: ltr;\n\n\t&::-ms-expand {\n\t\tdisplay: none;\n\t}\n\n\t&:disabled::-ms-expand {\n\t\tbackground: #f60;\n\t}\n\n\toption {\n\t\tcolor: initial;\n\t}\n"], ["\n\tcursor: pointer;\n\theight: 24px;\n\tmin-width: 24px;\n\tuser-select: none;\n\tpadding-left: 8px;\n\tpadding-right: 12px;\n\tbox-sizing: content-box;\n\tfont-size: inherit;\n\tcolor: inherit;\n\tborder: none;\n\tbackground-color: transparent;\n\tappearance: none;\n\tdirection: ltr;\n\n\t&::-ms-expand {\n\t\tdisplay: none;\n\t}\n\n\t&:disabled::-ms-expand {\n\t\tbackground: #f60;\n\t}\n\n\toption {\n\t\tcolor: initial;\n\t}\n"])));
var SelectWrapper = styled__default['default'].div(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n\tposition: relative;\n\tflex-shrink: 0;\n\tfont-size: inherit;\n\tcolor: inherit;\n\tmargin-top: 1px;\n\n\tsvg {\n\t\ttop: 0;\n\t\tright: 0;\n\t\tcolor: inherit;\n\t\tposition: absolute;\n\t\tfill: currentColor;\n\t\twidth: 24px;\n\t\theight: 24px;\n\t\tdisplay: inline-block;\n\t\tuser-select: none;\n\t\tpointer-events: none;\n\t}\n"], ["\n\tposition: relative;\n\tflex-shrink: 0;\n\tfont-size: inherit;\n\tcolor: inherit;\n\tmargin-top: 1px;\n\n\tsvg {\n\t\ttop: 0;\n\t\tright: 0;\n\t\tcolor: inherit;\n\t\tposition: absolute;\n\t\tfill: currentColor;\n\t\twidth: 24px;\n\t\theight: 24px;\n\t\tdisplay: inline-block;\n\t\tuser-select: none;\n\t\tpointer-events: none;\n\t}\n"])));
...
var PaginationWrapper = styled__default['default'].nav(templateObject_1$o || (templateObject_1$o = __makeTemplateObject(["\n\tdisplay: flex;\n\tflex: 1 1 auto;\n\tjustify-content: flex-end;\n\talign-items: center;\n\tbox-sizing: border-box;\n\tpadding-right: 8px;\n\tpadding-left: 8px;\n\twidth: 100%;\n\t", ";\n"], ["\n\tdisplay: flex;\n\tflex: 1 1 auto;\n\tjustify-content: flex-end;\n\talign-items: center;\n\tbox-sizing: border-box;\n\tpadding-right: 8px;\n\tpadding-left: 8px;\n\twidth: 100%;\n\t", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.pagination.style;
});
var Button = styled__default['default'].button(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n\tposition: relative;\n\tdisplay: block;\n\tuser-select: none;\n\tborder: none;\n\t", ";\n\t", ";\n"], ["\n\tposition: relative;\n\tdisplay: block;\n\tuser-select: none;\n\tborder: none;\n\t", ";\n\t", ";\n"])), function (_a) {
    var theme = _a.theme;
...
var PageList = styled__default['default'].div(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n\tdisplay: flex;\n\talign-items: center;\n\tborder-radius: 4px;\n\twhite-space: nowrap;\n\t", ";\n"], ["\n\tdisplay: flex;\n\talign-items: center;\n\tborder-radius: 4px;\n\twhite-space: nowrap;\n\t",
    ";\n"])), media.sm(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n    width: 100%;\n    justify-content: space-around;\n  "], ["\n    width: 100%;\n    justify-content: space-around;\n  "]))));
var Span = styled__default['default'].span(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n\tflex-shrink: 1;\n\tuser-select: none;\n"], ["\n\tflex-shrink: 1;\n\tuser-select: none;\n"])));
var Range = styled__default['default'](Span)(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["\n\tmargin: 0 24px;\n"], ["\n\tmargin: 0 24px;\n"])));
var RowLabel = styled__default['default'](Span)(templateObject_7$1 || (templateObject_7$1 = __makeTemplateObject(["\n\tmargin: 0 4px;\n"], ["\n\tmargin: 0 4px;\n"])));
function Pagination(_a) {
    ...
    var handleLast = React.useCallback(function () { return onChangePage(getNumberOfPages(rowCount, rowsPerPage)); }, [
        onChangePage,
        rowCount,
        rowsPerPage,
    ]);
    ...
    var select = (React.createElement(Select, { onChange: handleRowsPerPage, defaultValue: rowsPerPage, "aria-label": options.rowsPerPageText }, selectOptions));
...
var templateObject_1$o, templateObject_2$c, templateObject_3$6, templateObject_4$2, templateObject_5$1, templateObject_6$1, templateObject_7$1;
...
function DataTable(props) {
    var _a = props.data, data = _a === void 0 ? defaultProps.data : _a, _b = props.columns, columns = _b === void 0 ? defaultProps.columns : _b, _c = props.title, title = _c === void 0 ? defaultProps.title : _c, _d = props.actions, actions = _d === void 0 ? defaultProps.actions : _d, _e = props.keyField, keyField = _e === void 0 ? defaultProps.keyField : _e, _f = props.striped, striped = _f === void 0 ? defaultProps.striped : _f, _g = props.highlightOnHover, highlightOnHover = _g === void 0 ? defaultProps.highlightOnHover : _g, _h = props.pointerOnHover, pointerOnHover = _h === void 0 ? defaultProps.pointerOnHover : _h, _j = props.dense, dense = _j === void 0 ? defaultProps.dense : _j, _k = props.selectableRows, selectableRows = _k === void 0 ? defaultProps.selectableRows : _k, _l = props.selectableRowsHighlight, selectableRowsHighlight = _l === void 0 ? defaultProps.selectableRowsHighlight : _l, _m = props.selectableRowsNoSelectAll, selectableRowsNoSelectAll = _m === void 0 ? defaultProps.selectableRowsNoSelectAll : _m, _o = props.selectableRowsVisibleOnly, selectableRowsVisibleOnly = _o === void 0 ? defaultProps.selectableRowsVisibleOnly : _o, _p = props.selectableRowSelected, selectableRowSelected = _p === void 0 ? defaultProps.selectableRowSelected : _p, _q = props.selectableRowDisabled, selectableRowDisabled = _q === void 0 ? defaultProps.selectableRowDisabled : _q, _r = props.selectableRowsComponent, selectableRowsComponent = _r === void 0 ? defaultProps.selectableRowsComponent : _r, _s = props.selectableRowsComponentProps, selectableRowsComponentProps = _s === void 0 ? defaultProps.selectableRowsComponentProps : _s, _t = props.onRowExpandToggled, onRowExpandToggled = _t === void 0 ? defaultProps.onRowExpandToggled : _t, _u = props.onSelectedRowsChange, onSelectedRowsChange = _u === void 0 ? defaultProps.onSelectedRowsChange : _u, _v = props.expandableIcon, expandableIcon = _v === void 0 ? defaultProps.expandableIcon : _v, _w = props.onChangeRowsPerPage, onChangeRowsPerPage = _w === void 0 ? defaultProps.onChangeRowsPerPage : _w, _x = props.onChangePage, onChangePage = _x === void 0 ? defaultProps.onChangePage : _x, _y = props.paginationServer, paginationServer = _y === void 0 ? defaultProps.paginationServer : _y, _z = props.paginationServerOptions, paginationServerOptions = _z === void 0 ? defaultProps.paginationServerOptions : _z, _0 = props.paginationTotalRows, paginationTotalRows = _0 === void 0 ? defaultProps.paginationTotalRows : _0, _1 = props.paginationDefaultPage, paginationDefaultPage = _1 === void 0 ? defaultProps.paginationDefaultPage : _1, _2 = props.paginationResetDefaultPage, paginationResetDefaultPage = _2 === void 0 ? defaultProps.paginationResetDefaultPage : _2, _3 = props.paginationPerPage, paginationPerPage = _3 === void 0 ? defaultProps.paginationPerPage : _3, _4 = props.paginationRowsPerPageOptions, paginationRowsPerPageOptions = _4 === void 0 ? defaultProps.paginationRowsPerPageOptions : _4, _5 = props.paginationIconLastPage, paginationIconLastPage = _5 === void 0 ? defaultProps.paginationIconLastPage : _5, _6 = props.paginationIconFirstPage, paginationIconFirstPage = _6 === void 0 ? defaultProps.paginationIconFirstPage : _6, _7 = props.paginationIconNext, paginationIconNext = _7 === void 0 ? defaultProps.paginationIconNext : _7, _8 = props.paginationIconPrevious, paginationIconPrevious = _8 === void 0 ? defaultProps.paginationIconPrevious : _8, _9 = props.paginationComponent, paginationComponent = _9 === void 0 ? defaultProps.paginationComponent : _9, _10 = props.paginationComponentOptions, paginationComponentOptions = _10 === void 0 ? defaultProps.paginationComponentOptions : _10, _11 = props.responsive, responsive = _11 === void 0 ? defaultProps.responsive : _11, _12 = props.overflowY, overflowY = _12 === void 0 ? defaultProps.overflowY : _12, _13 = props.overflowYOffset, overflowYOffset = _13 === void 0 ? defaultProps.overflowYOffset : _13, _14 = props.progressPending, progressPending = _14 === void 0 ? defaultProps.progressPending : _14, _15 = props.progressComponent, progressComponent = _15 === void 0 ? defaultProps.progressComponent : _15, _16 = props.persistTableHead, persistTableHead = _16 === void 0 ? defaultProps.persistTableHead : _16, _17 = props.noDataComponent, noDataComponent = _17 === void 0 ? defaultProps.noDataComponent : _17, _18 = props.disabled, disabled = _18 === void 0 ? defaultProps.disabled : _18, _19 = props.noTableHead, noTableHead = _19 === void 0 ? defaultProps.noTableHead : _19, _20 = props.noHeader, noHeader = _20 === void 0 ? defaultProps.noHeader : _20, _21 = props.fixedHeader, fixedHeader = _21 === void 0 ? defaultProps.fixedHeader : _21, _22 = props.fixedHeaderScrollHeight, fixedHeaderScrollHeight = _22 === void 0 ? defaultProps.fixedHeaderScrollHeight : _22, _23 = props.pagination, pagination = _23 === void 0 ? defaultProps.pagination : _23, _24 = props.subHeader, subHeader = _24 === void 0 ? defaultProps.subHeader : _24, _25 = props.subHeaderAlign, subHeaderAlign = _25 === void 0 ? defaultProps.subHeaderAlign : _25, _26 = props.subHeaderWrap, subHeaderWrap = _26 === void 0 ? defaultProps.subHeaderWrap : _26, _27 = props.subHeaderComponent, subHeaderComponent = _27 === void 0 ? defaultProps.subHeaderComponent : _27, _28 = props.noContextMenu, noContextMenu = _28 === void 0 ? defaultProps.noContextMenu : _28, _29 = props.contextMessage, contextMessage = _29 === void 0 ? defaultProps.contextMessage : _29, _30 = props.contextActions, contextActions = _30 === void 0 ? defaultProps.contextActions : _30, _31 = props.contextComponent, contextComponent = _31 === void 0 ? defaultProps.contextComponent : _31, _32 = props.expandableRows, expandableRows = _32 === void 0 ? defaultProps.expandableRows : _32, _33 = props.onRowClicked, onRowClicked = _33 === void 0 ? defaultProps.onRowClicked : _33, _34 = props.onRowDoubleClicked, onRowDoubleClicked = _34 === void 0 ? defaultProps.onRowDoubleClicked : _34, _35 = props.sortIcon, sortIcon = _35 === void 0 ? defaultProps.sortIcon : _35, _36 = props.onSort, onSort = _36 === void 0 ? defaultProps.onSort : _36, _37 = props.sortFunction, sortFunction = _37 === void 0 ? defaultProps.sortFunction : _37, _38 = props.sortServer, sortServer = _38 === void 0 ? defaultProps.sortServer : _38, _39 = props.expandableRowsComponent, expandableRowsComponent = _39 === void 0 ? defaultProps.expandableRowsComponent : _39, _40 = props.expandableRowDisabled, expandableRowDisabled = _40 === void 0 ? defaultProps.expandableRowDisabled : _40, _41 = props.expandableRowsHideExpander, expandableRowsHideExpander = _41 === void 0 ? defaultProps.expandableRowsHideExpander : _41, _42 = props.expandOnRowClicked, expandOnRowClicked = _42 === void 0 ? defaultProps.expandOnRowClicked : _42, _43 = props.expandOnRowDoubleClicked, expandOnRowDoubleClicked = _43 === void 0 ? defaultProps.expandOnRowDoubleClicked : _43, _44 = props.expandableRowExpanded, expandableRowExpanded = _44 === void 0 ? defaultProps.expandableRowExpanded : _44, _45 = props.expandableInheritConditionalStyles, expandableInheritConditionalStyles = _45 === void 0 ? defaultProps.expandableInheritConditionalStyles : _45, _46 = props.defaultSortFieldId, defaultSortFieldId = _46 === void 0 ? defaultProps.defaultSortFieldId : _46, _47 = props.defaultSortAsc, defaultSortAsc = _47 === void 0 ? defaultProps.defaultSortAsc : _47, _48 = props.clearSelectedRows, clearSelectedRows = _48 === void 0 ? defaultProps.clearSelectedRows : _48, _49 = props.conditionalRowStyles, conditionalRowStyles = _49 === void 0 ? defaultProps.conditionalRowStyles : _49, _50 = props.theme, theme = _50 === void 0 ? defaultProps.theme : _50, _51 = props.customStyles, customStyles = _51 === void 0 ? defaultProps.customStyles : _51, _52 = props.direction, direction = _52 === void 0 ? defaultProps.direction : _52;
    var columnsMemo = React.useMemo(function () { return decorateColumns(columns); }, [columns]);
    var defaultSortDirection = getSortDirection(defaultSortAsc);
    var defaultSortColumn = React.useMemo(function () { return getColumnById(defaultSortFieldId, columnsMemo); }, [
        columnsMemo,
        defaultSortFieldId,
    ]);
    var initialState = {
    ...
    var _53 = React.useReducer(tableReducer, initialState), _54 = _53[0], rowsPerPage = _54.rowsPerPage, rows = _54.rows, currentPage = _54.currentPage, selectedRows = _54.selectedRows, allSelected = _54.allSelected, selectedCount = _54.selectedCount, selectedColumn = _54.selectedColumn, sortDirection = _54.sortDirection, dispatch = _53[1];
    var _55 = paginationServerOptions.persistSelectedOnSort, persistSelectedOnSort = _55 === void 0 ? false : _55, _56 = paginationServerOptions.persistSelectedOnPageChange, persistSelectedOnPageChange = _56 === void 0 ? false : _56;
    ...
    var currentTheme = React.useMemo(function () { return createStyles(customStyles, theme); }, [customStyles, theme]);
    var expandableRowsComponentMemo = React.useMemo(function () { return expandableRowsComponent; }, [expandableRowsComponent]);
    ...
    React.useEffect(function () {
        dispatch({
            type: 'UPDATE_ROWS',
            rows: (defaultSortColumn === null || defaultSortColumn === void 0 ? void 0 : defaultSortColumn.selector) ? sort(data, defaultSortColumn.selector, defaultSortDirection, sortFunction)
                : data,
        });
    }, [data]);
    React.useEffect(function () {
    ...
    return (React.createElement(styled.ThemeProvider, { theme: currentTheme },
        !noHeader && (React.createElement(TableHeader, { title: title, actions: actions, showMenu: !noContextMenu, selectedCount: selectedCount, direction: direction, contextActions: contextActions, contextComponent: contextComponent, contextMessage: contextMessage })),
        subHeader && (React.createElement(TableSubheader, { align: subHeaderAlign, wrapContent: subHeaderWrap }, subHeaderComponent)),
        React.createElement(ResponsiveWrapper, __assign({ responsive: responsive, overflowYOffset: overflowYOffset, overflowY: overflowY }, wrapperProps),
            React.createElement(TableWrapper, null,
                ...
                React.createElement(TableStyle, { disabled: disabled, className: "rdt_Table", role: "table" },
                    showTableHead() && (React.createElement(TableHead, { className: "rdt_TableHead", role: "rowgroup" },
                        React.createElement(TableHeadRow, { className: "rdt_TableHeadRow", role: "row", dense: dense, disabled: progressPending || rows.length === 0 },
                            selectableRows &&
                                (showSelectAll ? (React.createElement(CellBase, { style: { flex: '0 0 48px' } })) : (React.createElement(TableColCheckbox, { allSelected: allSelected, selectedRows: selectedRows, selectableRowsComponent: selectableRowsComponent, selectableRowsComponentProps: selectableRowsComponentProps, selectableRowDisabled: selectableRowDisabled, rowData: rowData, keyField: keyField, mergeSelections: mergeSelections, onSelectAllRows: handleSelectAllRows }))),
                            expandableRows && !expandableRowsHideExpander && React.createElement(TableColExpander, null),
                            columnsMemo.map(function (column) { return (React.createElement(TableCol$1, { key: column.id, column: column, rows: rows, pagination: pagination, paginationServer: paginationServer, persistSelectedOnSort: persistSelectedOnSort, selectableRowsVisibleOnly: selectableRowsVisibleOnly, selectedColumn: selectedColumn, sortFunction: sortFunction, sortDirection: sortDirection, sortIcon: sortIcon, sortServer: sortServer, onSort: handleSort })); })))),
                    !rows.length && !progressPending && React.createElement(NoDataWrapper, null, noDataComponent),
                    progressPending && persistTableHead && React.createElement(ProgressWrapper, null, progressComponent),
                    !progressPending && rows.length > 0 && (React.createElement(TableBody, { fixedHeader: fixedHeader, fixedHeaderScrollHeight: fixedHeaderScrollHeight, hasOffset: overflowY, offset: overflowYOffset, className: "rdt_TableBody", role: "rowgroup" }, calculatedRows.map(function (row, i) {
                        ...
                        return (React.createElement(TableRow, { id: id, key: id, keyField: keyField, row: row, columns: columnsMemo, selectableRows: selectableRows, expandableRows: expandableRows, expandableIcon: expandableIcon, highlightOnHover: highlightOnHover, pointerOnHover: pointerOnHover, dense: dense, expandOnRowClicked: expandOnRowClicked, expandOnRowDoubleClicked: expandOnRowDoubleClicked, expandableRowsComponent: expandableRowsComponentMemo, expandableRowsHideExpander: expandableRowsHideExpander, defaultExpanderDisabled: expanderDisabled, defaultExpanded: expanderExpander, expandableInheritConditionalStyles: expandableInheritConditionalStyles, conditionalRowStyles: conditionalRowStyles, rowCount: rows.length, rowIndex: i, selected: selected, selectableRowsHighlight: selectableRowsHighlight, selectableRowsComponent: selectableRowsComponent, selectableRowsComponentProps: selectableRowsComponentProps, selectableRowDisabled: selectableRowDisabled, striped: striped, onRowExpandToggled: onRowExpandToggled, onRowClicked: handleRowClicked, onRowDoubleClicked: handleRowDoubleClicked, onSelectedRow: handleSelectedRow }));
                    })))))),
        enabledPagination && (React.createElement("div", null,
            React.createElement(Pagination$1, { onChangePage: handleChangePage, onChangeRowsPerPage: handleChangeRowsPerPage, rowCount: paginationTotalRows || rows.length, currentPage: currentPage, rowsPerPage: rowsPerPage, direction: direction, paginationRowsPerPageOptions: paginationRowsPerPageOptions, paginationIconLastPage: paginationIconLastPage, paginationIconFirstPage: paginationIconFirstPage, paginationIconNext: paginationIconNext, paginationIconPrevious: paginationIconPrevious, paginationComponentOptions: paginationComponentOptions })))));
}
